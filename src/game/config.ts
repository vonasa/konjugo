...
export const CONFIG = {
  ...
  // a tier, then resets UP on tier-up to 95% of the previous tier's start clock.
  TIER_RESET_FACTOR: 0.95, // each new tier starts at 95% of the previous tier's start
